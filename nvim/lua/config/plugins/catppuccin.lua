    ...
    require("catppuccin").setup({
      ...
      highlight_overrides = {
        ...
        frappe = function(colors)
          return {
            Parameter = { fg = colors.nvchad_cyan },
            ["@parameter"] = { fg = colors.nvchad_cyan },
            ["@variable.parameter"] = { fg = colors.nvchad_cyan },
            Type = { fg = "NvimLightGreen" },
            ["@type.builtin"] = { fg = colors.green1 },
            ["@type.builtin.c"] = { fg = colors.green1 },
            Structure = { fg = "NvimLightGreen" },
            Keyword = { fg = "NvimLightMagenta" },
            ["@keyword.function"] = { fg = colors.nvchad_blue },
            ["@keyword.exception"] = { fg = colors.nvchad_red },
